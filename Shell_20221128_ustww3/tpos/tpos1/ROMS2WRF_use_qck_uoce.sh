...
# SST_In is the same file for the UV_In
...
if [ $SmoothSST = yes ]; then
	...
	cp $Couple_Lib_template_Dir/sst.nc $ROMS_Smooth_Before_Dir/sst_Hour$NHour.nc
	cp $Couple_Lib_template_Dir/sst.nc $ROMS_Smooth_After_Dir/sst_Hour$NHour.nc
	ln -fs $ROMS_Smooth_Before_Dir/sst_Hour$NHour.nc fort.51
	ln -fs $ROMS_Smooth_After_Dir/sst_Hour$NHour.nc fort.52
	...
	$NCO/ncbo --op_typ=- -O $ROMS_Smooth_Before_Dir/sst_Hour$NHour.nc $ROMS_Smooth_After_Dir/sst_Hour$NHour.nc $ROMS_Smooth_Diff_Dir/sst_diff_Hour$NHour.nc

	# write to wrflowinput at nt2
	ln -fs $Couple_Lib_grids_ROMS_Dir/$Nameit_ROMS-nxnyr.dat fort.11
	ln -fs $ROMS_Smooth_After_Dir/sst_Hour$NHour.nc fort.12 || exit 8
	...
	ln -fs $Couple_Lib_grids_ROMS_Dir/$Nameit_ROMS-nxnyr.dat fort.11
	ln -fs $Couple_Lib_grids_ROMS_Dir/$Nameit_ROMS-nxnyu.dat fort.17
	ln -fs $Couple_Lib_grids_ROMS_Dir/$Nameit_ROMS-nxnyv.dat fort.18
