...
run_ROMS_WRF_and_WW3()
{
    ...
    #Home Directory
    export Couple_Home_Dir=$PROJECT/hseo4/Git/wrf-ww3-ustar-working/SCOAR2/   
...
set_WRF_parameters()
{
    ...
    export WRFRST_SAVE_NUMBER=`expr 24 \/ $CF`
...
set_ROMS_parameters()
{
    ...
    export ROMS_Launch_Filename=romslaunch  #contains command to run ROMS
    ...
    ######### ROMS BOUNDARY AND INITIAL CONDITIONS HERE #############
    #################################################################
    #################################################################
    ...
    ##############################################################################
    #          ROMS INITIAL AND BOUNDARY DIRECTORIES                         #
    ##############################################################################
...
set_WW3_parameters()
{
    ...
    if [ $parameter_run_WW3 = yes ]; then
        export Nameit_WW3=ww3-$gridname
