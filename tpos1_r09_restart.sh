...
## needed for prepareROMS_Rst.sh to create ocean_in.nc
## this can be directly read from ocean.in file and can be done in prepareROMS_Rst.sh, and it can be removed here.
## things to do....
#export nd=30
